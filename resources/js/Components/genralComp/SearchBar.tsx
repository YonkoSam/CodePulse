                    ...
                    <ListItem>
                        {setSelectedObject ? (
                            <div className="flex items-center text-white">
                                ...
                                />
                                <Button
                                    onClick={() => setSelectedObject(value)}
                                >
                                    Select
                                </Button>
                            </div>
                ...
                return (
                    <ListItem>
                        {setSelectedObject ? (
                            ...
                            <Link
                                href={route("profiles.show", value.profile.id)}
                                className="cursor-pointer flex gap-x-3"
                            >
                                <FriendStatus
                                    friend={value}
                ...
                return (
                    <ListItem>
                        <div className="flex flex-col">
                            <Link
                                href={route("pulses.show", value.id)}
            ...
            <SpringModal isOpen={open} setIsOpen={setOpen}>
                ...
                <div className="mt-2">
                    {data.length > 0 ? (
                        ...
                        noResults && (
                            <span className="text-xs text-white text-center p-4">
