...
const Navbar = () => {
    ...
    return <div className="w-full container mx-auto mt-6">
        <div className="w-full flex items-center justify-between">
            <Link href='/' className="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl">
                Tawa<span
                ...
                <ul className='flex justify-between space-x-3'>
                    {!auth.user ? (
                        <>
                            ...
                            <Link method="post" href={route('logout')} className={liStyle} >Logout</Link>
                    )}
                </ul>
