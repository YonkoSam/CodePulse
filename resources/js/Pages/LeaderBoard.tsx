...
const LeaderboardRow = React.memo(
    ({ profile, index }: { profile: Profile; index: number }) => {
            ...
            >
                    ...
                    <div className="flex items-center">
                        <Avatar
                            ...
                            className={`w-12 h-12 ${
                                ...
                                profile.rank === 1
                                    ? "ring-yellow-300 ring-offset-yellow-500"
                                    : profile.rank === 2
                                    ? "ring-gray-200 ring-offset-gray-400"
                                    : profile.rank === 3
                                    ? "ring-yellow-500 ring-offset-yellow-700"
                                    : ""
                            }`}
                        />
                        <Typography
                ...
                {!isMobile && (
                    <>
                        ...
                        <TableCell
                            className={`text-sm ${
                                profile.rank <= 3 ? "font-bold" : "!text-white"
                            }`}
                        >
                    ...
                    <Table>
                        <TableHead>
                            <TableRow className="bg-gray-800">
                                <TableCell className="font-semibold !text-white p-4">
                                    Rank
                                </TableCell>
                                <TableCell className="font-semibold !text-white p-4">
                                    Name
