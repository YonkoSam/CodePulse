    ...
    const handleFriendRemove = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(
                    route("friend.delete", { friend: profile.user_id }),
                    {
                        onSuccess: () => {
                            Toast.fire({
                                icon: "success",
...
`,
            ...
            if (result.isConfirmed) {
                router.delete(
                    route("friend.block", { friend: profile.user_id }),
                    {
                        onSuccess: () => {
                            Toast.fire({
                                icon: "success",
                    ...
                    <Stack>
                        {profile ? (
                            <>
                                ...
                                >
                                    <BackgroundGradient>
                                        <div className="relative  mb-2 bg-black/80 rounded-3xl">
                                            ...
                                            <div className=" w-full flex flex-col md:flex-row md:justify-between justify-center  rounded-b-xl  ">
                                ...
                                <div className="grid gap-8 mt-3 mb-12 grid-cols-1 lg:grid-cols-2  xl:grid-cols-2 2xl:grid-cols-4">
                                    <motion.div
